...
function Footer() {
  return (
    <div data-scroll  data-scroll-section   className='w-full h-screen flex gap-1 bg-zinc-900 p-20'>
        <div className='w-1/2 h-full flex flex-col font-["Founders_Grotesk"] justify-between '>
            <div className='headinf'>
            <h1 className='text-[6vw] uppercase leading-none -mb-5 font-semibold tracking-tighter'>Eye-</h1>
            <h1 className='text-[6vw] uppercase leading-none -mb-5 font-semibold tracking-tighter'>Opening</h1>
            </div>
        ...
        <div className='w-1/2 flex flex-col gap-60'>
        <h1 className='text-[5vw] uppercase leading-none -mb-5 font-["Founders_Grotesk"] font-semibold tracking-tighter '>
            PRESENTATIONS
            </h1>
            <div className='dets'>
                {["facebook","instagram","twitter"].map((items,index)=>
                    <div key={index} className='text-5xl font-light capitalize py-3'>{items}</div>
                )}
